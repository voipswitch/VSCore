...
-(void)testStringHashSHA1{
    //generated by http://www.fileformat.info/tool/hash.htm?text=This+is+test+string
    NSString* test = @"This is test string";
    NSString* hexHash = [test hashSHA512];
    STAssertEqualObjects(hexHash, @"32c674bc65e692fbf9a9d91710b06ec9f2314e0e", @"Hash not valid");
}
...
-(void)testStringHashCRC{
    //generated by http://www.fileformat.info/tool/hash.htm?text=This+is+test+string
    NSString* test = @"This is test string";
    NSString* hexHash = [test hashCRC];
    STAssertEqualObjects(hexHash, @"b4cc8027", @"Hash not valid");
}
